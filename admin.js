...
const statusLabel=s=>({confirmed:"Confirmada",pending_payment:"Aguardando pagamento",hold:"Pagamento iniciado",cancelled:"Cancelada",not_confirmed:"Não confirmada",no_show:"Não compareceu",paid:"Pago",refused:"Recusado",under_review:"Em análise",processing:"Processando",awaiting_payment:"Aguardando pagamento",expired:"Expirado",requested:"Solicitada",quoted:"Aguardando análise",rejected:"Recusada",payment_expired:"Pagamento não realizado",accepted:"Aceita",applied:"Aplicada",active:"Ativa",authorized:"Autorizada",released:"Liberada",captured:"Capturada",incident_reported:"Ocorrência registrada",capture_requested:"Captura solicitada",upgraded:"Substituído"}[s]||String(s||"—").replaceAll("_"," "));

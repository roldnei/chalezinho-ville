...
O arquivo `phase1_schema_snapshot.sql` é um snapshot idempotente e documentado da estrutura alvo da Fase 1. As migrations originais permanecem registradas no histórico do Supabase.
